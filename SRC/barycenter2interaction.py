...
for p in range(1,27):
    ...
    I_clustering_dir= f"./Plots_Text/clustering/puzzle{p}/"
    soft_clustering_dir = f"./Plots_Text/clustering/softdtwscore/puzzle{p}/"

    for clustering_dir in [I_clustering_dir, soft_clustering_dir]:
